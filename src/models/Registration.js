...
const registrationSchema = new mongoose.Schema(
  {
    firstName: { type: String, required: [true, 'יש להזין שם פרטי'], trim: true, maxlength: 60 },
    lastName: { type: String, required: [true, 'יש להזין שם משפחה'], trim: true, maxlength: 60 },
    company: { type: String, required: [true, 'יש להזין שם חברה'], trim: true, maxlength: 120 },
    role: { type: String, required: [true, 'יש להזין תפקיד'], trim: true, maxlength: 80 },
    phone: {
      type: String,
